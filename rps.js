...
const showIcon = document.getElementById('playerChoice');
// update the HTML content of the showIcon element
showIcon.innerHTML = '<i class="fas fa-hand-paper"></i>';
const computerShowIcon = document.getElementById('computerChoice');



// update the HTML content of the computerShowIcon element
computerShowIcon.innerHTML = '<i class="fas fa-hand-rock"></i>';
...
// const computerShowIcon=document.querySelector('.show .computer i');
let computerScore=1;
let playerScore=1;
